 ...
 * Emitted when a deposit is added to a deposit invoice the invoiceable is attached to.
 *
 * @package App\Billing\Events
 */
final class InvoiceableDepositAdded implements InvoiceableEvent, DepositEvent
{
