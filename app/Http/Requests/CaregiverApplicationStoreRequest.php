...
class CaregiverApplicationStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'home_phone' => ['required', new PhonePossible()],
            ...
            'license_number' => 'nullable|string|required_if:certification,CNA,LPN,RN',
            'training_school' => 'nullable|string|required_if:certification,HHA',
