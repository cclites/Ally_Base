...
class AlterReferralSourcesAddContact extends Migration
{
    ...
    public function up()
    {
        Schema::table('referral_sources', function(Blueprint $table){
            $table->string('contact_address_street', 150)->nullable();
            $table->string('contact_address_street2', 50)->nullable();
            $table->string('contact_address_city', 100)->nullable();
            $table->string('contact_address_state', 50)->nullable();
            $table->string('contact_address_zip', 10)->nullable();
        });
    }
