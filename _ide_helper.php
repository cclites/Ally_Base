 ...
 * Generated for Laravel 5.8.36 on 2020-01-28 17:20:05.
 *
...
namespace  { 
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {         
             ...
             * @static 
             */ 
            public static function parseSub($query)
            {
                                return \Illuminate\Database\Query\Builder::parseSub($query);
            }
             ...
             * @static 
             */ 
            public static function createSub($query)
            {
                                return \Illuminate\Database\Query\Builder::createSub($query);
            }
        }
