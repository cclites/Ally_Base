<?php
/**
 * @var \App\Billing\CaregiverInvoice $invoice
 ...
 * @var \Illuminate\Support\Collection|App\Billing\Deposit[] $payments
 */
?>
@extends('invoices.layout')

@section('items')
    @include('invoices.partials.caregiver_items_table')
@endsection
