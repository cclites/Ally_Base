...
<li>
    <a class="has-arrow" href="{{ route('caregivers.manual-timesheets') }}" aria-expanded="false"><i class="fa fa-calendar-plus-o"></i><span class="hide-menu">Manual Timesheet</span></a>
</li>
@endif
