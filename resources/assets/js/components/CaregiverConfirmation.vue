            ...
            <b-col cols="12" md="6" lg="8">
                ...
                <b-card header="W-9 Request for Taxpayer Identification Number and Certification"
                    ...
                    <b-row>
                        <b-col>
                            <b-form-group>
                                <b-button @click="fillW9Fields">Fill with above info</b-button>
                            </b-form-group>
...
<script>
    export default {
        ...
        computed: {
            w9Address() {
                let address = this.form.address1;
        ...
        methods: {
            fillW9Fields() {
                this.form.w9.name = this.form.firstname + ' ' + this.form.lastname;
                this.form.w9.address = this.w9Address;
                this.form.w9.city_state_zip = this.w9CityStateZip;
                this.form.w9.ssn = this.form.ssn;
            },
