            ...
            items() {
                const reports = [
                    ...
                    },
                    {
                        ...
                        description: 'From the Client List page, click the Avery 5160 PDF button to generate labels',
                        category: 2,
                        allowed: ['office_user'],
                    },
                    {
                        name: 'Avery 5160 Mailing Labels',
                        url: '/business/caregivers',
                        description: 'From the Caregiver List page, click the Avery 5160 PDF button to generate labels',
                        category: 3,
                        allowed: ['office_user'],
                    },
                    {
