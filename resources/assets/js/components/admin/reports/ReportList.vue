        ...
        items() {
            if(this.role['role_type'] == 'admin') {
                ...
                return [
                    ...
                    // { name: 'Client Contacts', url: 'reports/', description: 'See a list of clients and their phone numbers and email address' },
                    // { name: 'Caregiver Contacts', url: 'reports/', description: 'See a list of caregivers and their phone numbers and email address' },
                    { name: 'Client & Caregiver Rates', url: 'reports/client_caregivers', description: 'View all rates between each client and caregiver' },
                    // { name: 'Referral Sources', url: 'reports/', description: 'List of referral sources and how many clients have been referred by each' },
                    // { name: 'Shifts by Caregiver', url: 'reports/', description: 'See how many shifts have been worked by a caregiver' },
                    // { name: 'Shifts by Client', url: 'reports/', description: 'See how many shifts a client has received' },
                    ...
                    // { name: 'Clients Missing Bank Accounts', url: 'reports/', description: 'Shows all clients missing a payment method' },
