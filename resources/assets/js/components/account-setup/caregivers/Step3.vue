            ...
            <b-row>
                ...
                <b-col cols="12" md="6" lg="4">
                    ...
                    <b-card
                        ...
                        header-text-variant="white"
                        header-bg-variant="info">
                        <p class="card-text">I hereby authorize Ally Home Care, LLC (Ally) to debit entries, and if necessary, credit entries to correct erroneous debits from the account at the Financial Institution named above.  If a debit is scheduled to take place on a non-banking date, the transaction will take place on the next banking day. I (we) acknowledge the origination of ACH transactions to our account must comply with the provisions of U.S. law.  This authority is to remain in full force and effect until Ally has received written notification from me of termination in such time and manner as to afford Ally and Financial Institution a reasonable opportunity to act on it.</p>
                        <p class="card-text">INDEPENDENT CONTRACTOR STATUS:  I hereby agree that I am an independent contractor and at no time am I employed by Ally Home Care, LLC (Ally). My signature below indicates my understanding of this and that Ally is merely an agent between myself and the home care clients for whom I work for. At no time will I claim employment from Ally Home Care, LLC.</p>
                    </b-card>
                </b-col>
            </b-row>
            <b-row>
