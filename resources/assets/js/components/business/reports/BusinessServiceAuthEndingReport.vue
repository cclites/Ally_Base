<template>
    <b-row>
        <b-col>
            <b-card header="Service Authorizations Ending Report"
            ...
            >
                <div class="form-inline mb-3">
                    ...
                    <b-col lg="3">
                        <b-form-group label="Show authorizations ending in:">
                            <b-form-input
                                type="number"
                                v-model="form.days"
                                placeholder="Days"
...
<script>
    ...
    export default {
        ...
        methods: {
            fetch() {
                this.busy = true;
                this.form.get('/business/reports/service-auth-ending')
                    .then( ({ data }) => {
                        this.items = data;
                    })
                    .catch(e => {})
            ...
            async loadClients() {
                ...
                this.clients = [];
                await axios.get(`/business/reports/service-auth-ending/clients?json=1&businesses=${this.form.businesses}`)
                    .then( ({ data }) => {
