<template>
    <b-row>
        <b-col>
            <b-card header="Offline AR Aging Report"
...
<script>
    ...
    export default {
        ...
        methods: {
            fetch() {
                this.busy = true;
                this.form.get('/business/reports/offline-ar-aging')
                    .then( ({ data }) => {
                        this.items = data;
            ...
            download() {
                window.location = this.form.toQueryString('/business/reports/offline-ar-aging?export=1');
            },
        },
