<template>
    <b-container fluid>
        ...
        <b-row class="with-padding-bottom" v-if="task.notes">
            <b-col sm="12">
                <strong>Notes</strong><br />
                <p v-html="$options.filters.nl2br(task.notes)" />
            </b-col>
        </b-row>
        <b-row class="with-padding-bottom">
            <b-col sm="6">
        ...
        <b-row class="with-padding-bottom" v-if="admin">
            <b-col sm="6">
        ...
        <b-row class="with-padding-bottom" v-if="admin && task.last_edit">
            <b-col sm="12">
