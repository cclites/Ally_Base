                ...
                >
                    ...
                    <b-form-group label="Specific Days Not Available to be Referred / Vacation Days">
                        ...
                        <b-form inline class="mb-2 align-items-baseline" @submit.prevent="addDayOff()">
                            ...
                            <date-picker v-model="dayoff_start" id="dayoff_start" class="mb-2 mr-2" placeholder="Select Start" required></date-picker>
                            <date-picker v-model="dayoff_end" id="dayoff_end" class="mb-2 mr-2" placeholder="Select End"></date-picker>
